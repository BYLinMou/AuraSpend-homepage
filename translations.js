...
const translations = {
    'zh-TW': {
        ...
        'pricing.subscription-feature3': '去除所有廣告',
        ...
        'pricing.lifetime-feature2': '自定義 AI 服務商 (BYOK)',
        'pricing.lifetime-feature3': '無限制轉帳記錄雲端儲存',
        'pricing.lifetime-feature4': '永久去除所有廣告',
    ...
    'en': {
        ...
        'pricing.subscription-feature3': 'Remove all ads',
        ...
        'pricing.lifetime-feature2': 'Custom AI provider (BYOK)',
        'pricing.lifetime-feature3': 'Unlimited cloud storage for transaction records',
        'pricing.lifetime-feature4': 'Permanently remove all ads',
